...
//	public static final String VIEW_REPORT_CARD = "select * from reportcard where studentId_report = ? and semester = ?;";	
	public static final String VIEW_REPORT_CARD = "select * from semesterregistration where studentId = ? and semester = ?;";
...
//	public static final String ADD_REPORT_CARD=" insert into reportcard(studentId_report , cpi,semester) values (? , ? , ?);";
	public static final String ADD_REPORT_CARD=" insert into semesterregistration(studentId ,courseId,semester,grade) values (? , ? , ? , ?);";
